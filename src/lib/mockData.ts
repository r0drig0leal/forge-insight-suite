...
export const mockPropertyData: Record<string, PropertyData> = {
  "12345": {
    ...
    mail_address: "1247 Ocean Drive Apt 101",
  ...
  "1234567890": {
    ...
    mail_address: "789 Bay Shore Drive, Suite 5",
    mail_city: "Tampa",
    mail_state: "FL",
    mail_zip: "33602",
    property_city: "Tampa",
  ...
  "0987654321": {
    ...
    mail_address: "321 Riverside Avenue, Unit 2B",
  ...
  "1122334455": {
    ...
    mail_address: "555 Las Olas Boulevard, PH",
